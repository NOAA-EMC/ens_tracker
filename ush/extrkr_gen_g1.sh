...
#     300 to 900 mb, every 50 mb....
	...
	echo " "
	set -x
	err_exit "FAILED ${jobid} -vint_g1.x-  for GPH AT LINE $LINENO - ABNORMAL EXIT, Geopotential Height is missing, which is essential for interpolating height data"
      fi
...
#     300 to 500 mb, every 50 mb....
	...
	echo " "
	set -x
	err_exit "FAILED ${jobid} -vint_g1.x-  for T AT LINE $LINENO - ABNORMAL EXIT, Temperature is missing, which is essential for interpolating temperature data"
      fi
